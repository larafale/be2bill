...
module.exports = function(options) {
  ...
  options = _.extend(options || {}, {
    ...
    url: options.production
      ? 'https://secure-magenta1.be2bill.com/front' + endPoint
      : 'https://secure-test.be2bill.com/front' + endPoint
  })
  ...
  return {
    ...
    export: function(params, cb){
      ...
      this.request('/export.php', type, params, cb)
    ...
    getForm: function(method, params, cb){
      params = _.extend({ 
        operationtype: 'authorization',
        description: utils.random(),
        clientident: utils.random(),
      ...
      this.request('/front/form/process', method, params, cb)
    }
