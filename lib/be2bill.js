...
module.exports = function(options) {
  ...
  options = _.extend(options || {}, {
    ...
    url: options.production ? 
        'https://secure-magenta1.be2bill.com/front/service/rest'
      : 'https://secure-test.be2bill.com/front/service/rest'
  })
  ...
  return {
    ...
    payment: function(params, cb){
      ...
      this.request('/process.php', 'payment', params, cb)
    ...
    authorization: function(params, cb){
      ...
      this.request('/process.php', 'authorization', params, cb)
    ...
    capture: function(params, cb){
      ...
      this.request('/process.php', 'capture', params, cb)
    ...
    refund: function(params, cb){
      ...
      this.request('/process.php', 'refund', params, cb)
    ...
    credit: function(params, cb){
      ...
      this.request('/process.php', 'credit', params, cb)

    }, 

    exportChargeBacks: function(params, cb){
      ...
      this.request('/export.php', 'exportChargebacks', params, cb)
    ...
    parametize: function(method, params){
      ...
      var topLevel = 'method=' + method + '&'
        , secondLevel = _.map(params, function(val, key){ 
            return "params["+ key.toUpperCase()+"]="+encodeURIComponent(val) 
          }).sort().join('&')
